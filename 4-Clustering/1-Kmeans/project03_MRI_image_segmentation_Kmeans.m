...
%  
%  Description     : Application of K-Means clustering on grayscale medical 
%                    images (breast tissue) for intensity-based segmentation.
%                    After clustering, morphological operations are applied 
...
k=4;
Nepoch=30;
[labels,centers] = mykmeans(vectI,k,Nepoch);
J= zeros(size(labels));
for i=1:k
    indx= find(labels==i);
    J(indx)= centers(i);
