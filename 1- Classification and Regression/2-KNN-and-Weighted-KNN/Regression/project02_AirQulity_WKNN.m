...
%  Algorithm       : Weighted K-Nearest Neighbors Regressor (from scratch)
%  
%  Description     : Manual implementation of Weighted KNN for regression 
%                    on the UCI Air Quality dataset (distance-based weighting).
...
predicted_output= mywknnregression1(MDL,datatest);
%% validation
figure
