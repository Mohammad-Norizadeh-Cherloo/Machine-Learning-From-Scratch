...
%  
%  Description     : Manual implementation of Euclidean Distance classifier 
...
for i=1:100
    ...
    [MDL] = myEuqlideantrain(datatrain,dtrain);
    %% step 3: classify test data using trained classifier
    [predictedLables] =  myEuqlideanclassify(MDL,datatest);
    %% step 4: validation
